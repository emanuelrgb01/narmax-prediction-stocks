...
% Criando as redes neurais de 2 camadas com 25 neuronios em cada camada
net_petro = feedforwardnet([25, 25]);
net_vale = feedforwardnet([25, 25]);
net_embr = feedforwardnet([25, 25]);
...
net_petro.layers{2}.dimensions = 25;
net_petro.layers{2}.transferFcn = 'tansig';
net_petro.layers{3}.transferFcn = 'purelin';
net_petro.performFcn = 'mse';
net_petro.trainFcn = 'trainbr'; % Bayesian Regularization
net_petro.trainParam.epochs = 200;
...
net_vale.layers{2}.dimensions = 25;
net_vale.layers{2}.transferFcn = 'tansig';
net_vale.layers{3}.transferFcn = 'purelin';
net_vale.performFcn = 'mse';
net_vale.trainFcn = 'trainbr'; % Bayesian Regularization
net_vale.trainParam.epochs = 200;
...
net_embr.layers{1}.dimensions = 25;
net_embr.layers{1}.transferFcn = 'tansig';
net_embr.layers{2}.dimensions = 25;
net_embr.layers{2}.transferFcn = 'tansig';
net_embr.layers{3}.transferFcn = 'purelin';
net_embr.performFcn = 'mse';
net_embr.trainFcn = 'trainbr'; % Bayesian Regularization
net_embr.trainParam.epochs = 200;
